...
func (cc *CarCreate) SetValue(s string) *CarCreate {
...
func (cc *CarCreate) SetUserID(id int64) *CarCreate {
	cc.mutation.SetUserID(id)
	return cc
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (cc *CarCreate) SetNillableUserID(id *int64) *CarCreate {
	if id != nil {
		cc = cc.SetUserID(*id)
	}
	return cc
...
func (cc *CarCreate) check() error {
	...
	if _, ok := cc.mutation.Value(); !ok {
		return &ValidationError{Name: "value", err: errors.New(`ent: missing required field "Car.value"`)}
	}
	return nil
}
