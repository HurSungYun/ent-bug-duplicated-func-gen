...
func (cu *CarUpdate) SetValue(s string) *CarUpdate {
	cu.mutation.SetValue(s)
	return cu
}

// SetUserID sets the "user" edge to the User entity by ID.
func (cu *CarUpdate) SetUserID(id int64) *CarUpdate {
	cu.mutation.SetUserID(id)
	return cu
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (cu *CarUpdate) SetNillableUserID(id *int64) *CarUpdate {
	if id != nil {
		cu = cu.SetUserID(*id)
	}
	return cu
...
// SetValue sets the "value" field.
func (cuo *CarUpdateOne) SetValue(s string) *CarUpdateOne {
	cuo.mutation.SetValue(s)
	return cuo
}

// SetUserID sets the "user" edge to the User entity by ID.
func (cuo *CarUpdateOne) SetUserID(id int64) *CarUpdateOne {
	cuo.mutation.SetUserID(id)
	return cuo
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (cuo *CarUpdateOne) SetNillableUserID(id *int64) *CarUpdateOne {
	if id != nil {
